function plot_var_trans_ijcv    
    ...
    m2_med_times = [];
    for case_ind = 1:10
        load(['t_scale_noise_ijcv_' int2str(case_ind) '.mat']);
        ...
        m1_avg_times = [m1_avg_times; method_list(1).mean_time];
        m2_avg_times = [m2_avg_times; method_list(2).mean_time];
        m1_med_times = [m1_med_times; method_list(1).med_time];
        m2_med_times = [m2_med_times; method_list(2).med_time];
    end
...
%         correct_margin();
    ...
    print(h,'figs/var_trans.pdf','-dpdf','-r0')
